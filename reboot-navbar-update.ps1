...
# Navbar rectangular, sin transparencia, con logo SVG y REBOOT en mayúsculas; menú hamburguesa en móvil
WriteUtf8 "src/components/Navbar.tsx" @"
\"use client\";
  ...
  return (
    <header className="fixed top-4 inset-x-0 z-50">
      <div className="mx-auto max-w-7xl px-4">
        {/* Barra rectangular con bordes redondos (NO píldora) */}
...
Write-Host "✅ Navbar actualizada. Si ya tienes /public/images/logo-reboot.svg, verás el logo al recargar." -ForegroundColor Green
